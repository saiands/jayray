"""
Django settings for jayray project.
...
SECRET_KEY = 'django-insecure-%s$ho5-x!_pe)@!y2y883nu9qrzv5^d8!--c=s6p71h_7yrrt0'
...
WSGI_APPLICATION = 'jayray.wsgi.application'
